...
/**
 * Retrieves the animation to display progress along the circumference of a circle
...
const renderStatsCard = (
  ...
  // Filter out hidden stats and create text nodes
